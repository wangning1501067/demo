...
public class SendQQMailUtil {
    ...
    public static void main(String[] args) throws AddressException,MessagingException {
        ...
        // 设置发件人邮箱地址
        message.setFrom(new InternetAddress("417345853@qq.com"));
        // 设置收件人邮箱地址
        ...
        message.setRecipient(Message.RecipientType.TO, new InternetAddress("810453391@qq.com"));//一个收件人
        // 设置邮件标题
        ...
        // 连接自己的邮箱账户
        transport.connect("417345853@qq.com", "wsiagvyimhrmcbaf");// 密码为QQ邮箱开通的stmp服务后得到的客户端授权码
        // 发送邮件
